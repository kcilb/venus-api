...
public class AlertRequest implements Serializable {
    ...
    public int getSmsAlertCrncyId() {
        return smsAlertCrncyId;
    }

    public void setSmsAlertCrncyId(int smsAlertCrncyId) {
        this.smsAlertCrncyId = smsAlertCrncyId;
    }

    public String getGlPrefixCd(){
        return glPrefixCd;
    }

    public void setGlPrefixCd(String glPrefixCd) {
        this.glPrefixCd = glPrefixCd;
    }
